            ...
            <?php foreach ($usuarios as $user): ?>
                <div class="usuario-card">
                    ...
                    <div class="usuario-acoes">
                        ...
                        <a href="../../php/usuarios/proc_deletar_users.php?id=<?php echo urlencode($user['id']); ?>" class="btn btn-excluir" onclick="return confirm('Tem certeza que deseja excluir este usuário?')">Excluir</a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
