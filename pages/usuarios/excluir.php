...
// Recebe id para exclusão via GET, normalmente.
$id = $_GET['id'] ?? null;
if (!$id) {
...
// Aqui você pode buscar o nome do usuário para mostrar na confirmação
$usuario = ['nome' => 'João Silva']; // Exemplo
?>
...
<head>
    ...
    <title>Excluir Usuário - Gerenciador de PDF</title>
